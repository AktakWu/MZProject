...
class CourseAdmin(admin.ModelAdmin):
    ...
    list_display = ('name','teacher','date_publish')
...
@admin.register(RecommendedReading)
class recommended(admin.ModelAdmin):
    list_display = ('title','reading_type',)

# admin.site.register(CareerCourse)#职业课程
@admin.register(CareerCourse)
class careercrourse(admin.ModelAdmin):
    list_display = ('name','image','student_count','click_count',)
